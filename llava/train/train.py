...
class ModelArguments:
    ...
    fga_pretrained: Optional[str] = field(default=None, metadata={
        "help": "Path to the pretrained FGA model."
    })
...
def train(attn_implementation=None):
    ...
    if training_args.eval:
        ...
        model_path = str(os.path.dirname(model_args.pretrain_mm_mlp_adapter))
        model_name = 'llava-lora'
        load_pretrained_model(model_path, model_args.model_name_or_path, model_name)
